...
static int showtags           = 1;        /* 0 means don't draw tags; can be toggled with toggletagdraw */
...
static Key keys[] = {
	...
	{ MODKEY,			XK_equal,	spawn,		SHCMD("pamixer -i 2; kill -44 $(pidof dwmblocks)") },
	...
	{ ControlMask|ShiftMask,		XK_d,		spawn,		SHCMD("discord") },
    ...
    { MODKEY|ShiftMask, XK_F6,  spawn,         SHCMD("rotate-screen")},
